...
function* uploadImages(action) {
  try {
    ...
    yield Object(effects_["put"])({
      type: post["G" /* UPLOAD_IMAGES_SUCCESS */],
      data: result.data
    });
  } catch (err) {
    console.error(err);
    yield Object(effects_["put"])({
      type: post["E" /* UPLOAD_IMAGES_FAILURE */],
      error: err.response.data
    });
  }
}
...
function* watchUploadImages() {
  yield Object(effects_["takeLatest"])(post["F" /* UPLOAD_IMAGES_REQUEST */], uploadImages);
}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return UPLOAD_IMAGES_REQUEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return UPLOAD_IMAGES_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return UPLOAD_IMAGES_FAILURE; });
